...
def test_check_for_pre_existing_user_true_for_email_only():
    ...
    exists = reader.check_if_user_is_registered_already('testuder', 'testuser1@gmail.com' )
    assert exists
...
def test_check_for_pre_existing_user_true_for_username_only():
    ...
    exists = reader.check_if_user_is_registered_already('testuser', 'testuser2@gmail.com' )
    assert exists
...
def test_check_for_pre_existing_user_false():
    ...
    exists = reader.check_if_user_is_registered_already('testuder', 'testuser2@gmail.com' )
    assert not exists
...
def test_checking_room_availability_true():
    ...
    available = reader.check_for_room_availability('2B14', '2006-02-18','08:00:00','03:00:00')
...
def test_checking_room_availability_false_same_start_time():
    ...
    available = reader.check_for_room_availability('1f05', '2006-02-04','15:00:00','03:00:00')
...
def test_checking_room_availability_false_duration_leaks_into_existing_booking():
    ...
    available = reader.check_for_room_availability('1f05', '2006-02-04','12:00:00','03:30:00')
...
def test_checking_room_availability_false_existing_duration_leaks_into_booking():
    ...
    available = reader.check_for_room_availability('1f05', '2006-02-04','10:30:00','01:00:00')
...
def test_getting_booking_start_and_end_times():
    ...
    times = reader.get_booking_start_and_end_times_for_specific_room_include_date('1F05')
...
def test_create_new_booking_success():
    ...
    booking_created = writer.create_new_booking(booking_info[0],booking_info[1],booking_info[2],booking_info[3],booking_info[4])
...
def test_create_new_booking_failure_booking_size_too_large():
    ...
    booking_created = writer.create_new_booking(booking_info[0],booking_info[1],booking_info[2],booking_info[3],booking_info[4])
    assert booking_created[0] == False
    assert booking_created[1] == "Room IS Available, but the specified meetingSize is greater than the room's capacity"
