      ...
      <section class="section container is-fluid">
        <div class="columns">
          <div class="column">
            ...
            <div id="sandbox">
              <div class="control"><input type="text" class="input date"></div>
            </div>
            <div id="elem-attribs" class="is-flex is-flex-wrap-wrap mt-2">
              ...
              <div class="px-1">
                ...
                <label class="checkbox mx-1" style="display: none;">
          ...
          <div class="tile is-child">
            ...
            <form id="options">
              ...
              <div class="field">
                <div class="control">
                  <label class="label checkbox">
                    <input type="checkbox" name="clearButton" value="true">
                    clearButton
                  </label>
                </div>
              </div>
              ...
              <div class="field">
                ...
                <div id="datesDisabled-arr" class="control tooltip" data-tooltip="enter in JSON format">
              ...
              <div class="field">
                <div class="control">
                  <label class="label checkbox">
                    <input type="checkbox" name="enableOnReadonly" value="true" checked>
                    enableOnReadonly
                  </label>
                </div>
              </div>
              ...
              <div class="field">
                <div class="control">
                  <label class="label checkbox">
                    <input type="checkbox" name="todayButton" value="true">
                    todayButton
                  </label>
                </div>
              </div>
